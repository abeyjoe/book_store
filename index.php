...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5 bg-dark">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2025 - <?php echo $_SESSION['system']['name'] ?> | <a href="http://abeyjoe.netlify.app/" target="_blank">Abeyjoe</a></div></div>
        </footer>
